...
String WithdrawalCOLLECTION = "withdrawals";
...
class FirebaseHelper {
  ...
  CollectionReference<Map<String, dynamic>> withdrawalCollectionRef() {
    return FirebaseFirestore.instance.collection(WithdrawalCOLLECTION);
  }
